...
const batter_preview_js_1 = require("./batter-preview.js");
...
class Renderer {
    ...
    constructor(canvas, assets) {
        this.canvas = canvas;
        this.assets = assets;
        this.batterCursor = new batter_preview_js_1.BatterPreview(canvas, assets);
...
},{"./assets.js":"src/render/assets.js","./vector.js":"src/render/vector.js","./resources.js":"src/render/resources.js","../presentation-profile.js":"src/presentation-profile.js","./carry-cursor.js":"src/render/carry-cursor.js","./batter-preview.js":"src/render/batter-preview.js"}],
...
"src/render/batter-preview.js":[function(module,exports,require){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.BatterPreview = void 0;
const carry_cursor_js_1 = require("./carry-cursor.js");
...
class BatterPreview {
    ...
    height = 0;
    get active() { return this.enabled; }
    get memoryBytes() { return this.surface ? this.surface.width * this.surface.height * 4 : 0; }
    constructor(canvas, assets) {
        this.canvas = canvas;
        this.assets = assets;
    }
    createLayer() {
        ...
        this.clip.dataset.batterPreview = '';
        ...
        this.clip.append(this.surface);
        this.canvas.parentElement?.append(this.clip);
    }
    reset() {
        this.show(false);
        this.key = '';
    ...
    async prepare(width, height, cssWidth, cssHeight) {
        const key = `${width}:${height}:${cssWidth}:${cssHeight}`;
        if (this.key === key)
            return;
        this.reset();
        const art = this.assets.vector, template = this.assets.placement('mcDosa'), bounds = art?.frameBounds(472, 1);
        if (!art || !template || !bounds)
            return;
        const g = (0, carry_cursor_js_1.cursorGeometry)(bounds, template.matrix, width, height, cssWidth, cssHeight);
        if (!g.supported)
            return;
        this.createLayer();
    ...
    move(x, y) {
        if (!this.enabled || !this.geometry || !this.clip || !this.surface)
            return;
        const rect = this.canvas.getBoundingClientRect(), g = this.geometry;
        this.clip.style.left = rect.left + 'px';
        this.clip.style.top = rect.top + 'px';
        this.clip.style.width = rect.width + 'px';
        this.clip.style.height = rect.height + 'px';
...
exports.BatterPreview = BatterPreview;

},{"./carry-cursor.js":"src/render/carry-cursor.js"}],
