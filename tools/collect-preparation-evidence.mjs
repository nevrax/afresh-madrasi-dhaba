...
const evidence={scope:'Visible browser callback cadence and process CPU, not physical scanout or GPU utilization. One CPU core equals 100 percent. Normal synchronization and exact vector density retained. Compact native cursor is an intentional Optimized treatment; Classic and touch keep Canvas artwork.',pi:[],desktop:[],verification:[]};
